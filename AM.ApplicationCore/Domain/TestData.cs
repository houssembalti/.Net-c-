...
namespace AM.ApplicationCore.Domain
{
    internal class TestData
    {
        ...
        //{
        //    new Staff{="captain",LastName="captain",Emailadress="captain.captain@gmail.com",EmployeementDate=new DateTime(1999,01,01),Salary=99999,BirthDate=new DateTime(1965,01,01)}
        //};
